...
@Serializable
data class CreateRoomReq(@SerialId(1) val gameHash: String, @SerialId(2) val name: String, @SerialId(3) val cost: Long = 0, @SerialId(4) val timeout: Long = 0) : Data()
...
@Serializable
data class SurrenderResp(@SerialId(1) val roomId: String, @SerialId(2) val winner: String? = null, @SerialId(3) val r: ByteArrayWrapper? = null) : Data()
